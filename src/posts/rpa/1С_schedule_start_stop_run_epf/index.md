...
---
ЧЕРНОВИКИ Сделаем скриншот кнопки "О программе" ![окно](./alt_info.png) и напишем код, который нажмет `alt` стрелку вниз
и будет ждать появления кнопки "О программе":
